...
export class AccionesService {
  ...
  crearAccion(data: any): Observable<ApiResponse<{ accion: AccionCorrectiva }>> {
    return this.http.post<ApiResponse<{ accion: AccionCorrectiva }>>(
      `${environment.apiUrl}/acciones-correctivas`,
      data
    );
  }
  ...
  obtener(id: number): Observable<ApiResponse<AccionCorrectiva>> {
    return this.http.get<ApiResponse<AccionCorrectiva>>(
      `${environment.apiUrl}/acciones-correctivas/${id}`
    );
  }
  ...
  iniciar(id: number): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(
      `${environment.apiUrl}/acciones-correctivas/${id}/iniciar`,
      {}
    );
  }
  ...
  enviarValidacion(id: number, observaciones: string): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(
      `${environment.apiUrl}/acciones-correctivas/${id}/enviar-validacion`,
      { observaciones }
    );
  }
  ...
  devolver(id: number, observaciones: string): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(
      `${environment.apiUrl}/acciones-correctivas/${id}/devolver`,
      { observaciones }
    );
  }
  ...
  cerrar(id: number, observaciones: string): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(
      `${environment.apiUrl}/acciones-correctivas/${id}/cerrar`,
      { observaciones }
    );
  }
}